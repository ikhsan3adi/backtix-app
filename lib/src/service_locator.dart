...
class ServiceLocator {
  static Future<void> initializeDependencies() async {
    ...
    GetIt.I.registerLazySingleton<ThemeModeCubit>(() => ThemeModeCubit());
    GetIt.I.registerLazySingleton<OnboardingCubit>(() => OnboardingCubit());
  ...
  static Future<DioClient> initDio() async {
  ...
  static Future<void> initPaymentService() async {
